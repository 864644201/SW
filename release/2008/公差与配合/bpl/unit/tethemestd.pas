{==============================================================================
  ...
  $Id: tethemestd.pas,v 1.5 2002/10/28 21:04:02 Evgeny Exp $
...
constructor TTeThemeStd.Create;
begin
  inherited Create;
end;

destructor TTeThemeStd.Destroy;
begin
  inherited Destroy;
end;
...
function TTeThemeStd.GetColor(Color: TTeThemeColor): TColor;
begin
  case Color of
    { Forms }
    ...
    ngcHotHighlight: Result := RGB(230, 220, 220);
    { Menus }
...
function TTeThemeStd.GetFontName(Font: TTeThemeFont): string;
begin
  case Font of
...
function TTeThemeStd.GetFontSize(Font: TTeThemeFont): integer;
begin
  case Font of
...
function TTeThemeStd.GetFontStyle(Font: TTeThemeFont): TFontStyles;
begin
  case Font of
...
function TTeThemeStd.GetMetrix(Metrix: TTeThemeMetrix): integer;
begin
  case Metrix of
...
class function TTeThemeStd.GetThemeName: string;
begin
  Result := 'Advanced';
end;

class function TTeThemeStd.UseTheme: boolean;
begin
  Result := true;
end;

procedure TTeThemeStd.ChangeThemeColors;
begin
end;

{ Form Draw ===================================================================}

procedure TTeThemeStd.DrawSysButton(Canvas: TCanvas; R: TRect; Kind: TTeThemeSysButton;
...
procedure TTeThemeStd.DrawWindow(Canvas: TCanvas; Width,
...
procedure TTeThemeStd.CalcMenuBarItem(Canvas: TCanvas;
...
procedure TTeThemeStd.CalcMenuItem(Canvas: TCanvas; Item: TTeCustomItem;
...
procedure TTeThemeStd.DrawMenuBar(Canvas: TCanvas; Width,
  Height: integer);
begin
  FillRect(Canvas, Rect(0, 0, Width, Height), GetColor(ngcMenuBar));
end;

procedure TTeThemeStd.DrawPopupMenu(Canvas: TCanvas; Width,
  Height: integer);
var
  R: TRect;
begin
  ...
  InflateRect(R, -1, -1);
  DrawEdge(Canvas, R, GetColor(ngcMenuBar), SunkenColor(GetColor(ngcMenuBar), InnerValue));
  InflateRect(R, -1, -1);
  DrawEdge(Canvas, R, GetColor(ngcMenuBar), GetColor(ngcMenuBar));
end;

procedure TTeThemeStd.DrawMenuBarItem(Canvas: TCanvas;
...
procedure TTeThemeStd.DrawMenuBarIcons(Canvas: TCanvas; Item: TTeCustomItem;
...
procedure TTeThemeStd.DrawMenuItem(Canvas: TCanvas; Item: TTeCustomItem;
  Rect: TRect; Active, Hover: boolean);
const
...
procedure TTeThemeStd.DrawMenuScrollButton(Canvas: TCanvas;
...
procedure TTeThemeStd.DrawButton(Canvas: TCanvas; Width, Height: integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      InflateRect(R, -1, -1);
      DrawEdge(Canvas, R, LSColor, BackColor);
      InflateRect(R, -1, -1);
    ...
    begin
      ...
      InflateRect(R, -1, -1);
      DrawEdge(Canvas, R, BackColor, LSColor);
      InflateRect(R, -1, -1);
...
procedure TTeThemeStd.DrawCheckBox(Canvas: TCanvas; Rect: TRect;
...
begin
  ...
  InflateRect(Rect, -1, -1);
  DrawEdge(Canvas, Rect, SunkenColor(GetColor(ngcBtnFace), OuterValue), GetColor(ngcBtnFace));
  InflateRect(Rect, -1, -1);
...
procedure TTeThemeStd.DrawRadioButton(Canvas: TCanvas; Rect: TRect;
  ButtonState: TTeThemeButtonState; CheckState: TTeThemeCheckBoxState);
var
...
procedure TTeThemeStd.DrawTrackBarThumb(Canvas: TCanvas; R: TRect;
...
procedure TTeThemeStd.DrawTrackBar(Canvas: TCanvas; R, HighlightR: TRect);
var
  Color: TColor;
begin
  Color := GetColor(ngcBtnFace);
...
procedure TTeThemeStd.DrawProgessFrame(Canvas: TCanvas; R: TRect);
var
  Color: TColor;
begin
  Color := GetColor(ngcBtnFace);
...
procedure TTeThemeStd.DrawProgessBar(Canvas: TCanvas; R, BarR: TRect;
...
procedure TTeThemeStd.DrawPanel(Canvas: TCanvas; R: TRect; ShowBevel, ShowCaption: boolean);
begin
  { Draw Panel Face }
  if ShowBevel then
  begin
...
procedure TTeThemeStd.DrawPanelCaption(Canvas: TCanvas; R: TRect; Caption: WideString);
begin
  { Draw line }
...
procedure TTeThemeStd.DrawPanelButton(Canvas: TCanvas; R: TRect;
...
procedure TTeThemeStd.DrawGroupBox(Canvas: TCanvas; R, CaptionRect: TRect;
  Caption: WideString);
begin
  { Draw Frame }
  MoveTo(Canvas, R.Left, R.Top);
...
procedure TTeThemeStd.DrawScrollBar(Canvas: TCanvas; R: TRect;
  Kind: TScrollBarKind);
begin
  FillHalftoneRect(Canvas, R, GetColor(ngcBtnFace), clWhite);
end;

procedure TTeThemeStd.DrawScrollBarButton(Canvas: TCanvas; R: TRect;
...
begin
  ...
  begin
    DrawEdge(Canvas, R, SunkenColor(BackColor, OuterValue), RaisedColor(BackColor, OuterValue));
    InflateRect(R, -1, -1);
    DrawEdge(Canvas, R, SunkenColor(BackColor, InnerValue), BackColor);
    InflateRect(R, -1, -1);
  end
  else
  begin
    DrawEdge(Canvas, R, RaisedColor(BackColor, OuterValue), SunkenColor(BackColor, OuterValue));
    InflateRect(R, -1, -1);
    DrawEdge(Canvas, R, BackColor, SunkenColor(BackColor, InnerValue));
    InflateRect(R, -1, -1);
  end;
  FillRect(Canvas, R, BackColor);
...
procedure TTeThemeStd.DrawScrollBarSlider(Canvas: TCanvas; R: TRect;
...
procedure TTeThemeStd.DrawTabBorder(Canvas: TCanvas; R: TRect);
begin
...
procedure TTeThemeStd.DrawTab(Canvas: TCanvas; R: TRect; TabPosition: TTabPosition; State: TTeThemeButtonState);
var
  Color: TKColor;
begin
  if State = ngsHot then
...
procedure TTeThemeStd.DrawTabScrollButton(Canvas: TCanvas; R: TRect; LeftTop: boolean;
  TabPosition: TTabPosition; State: TTeThemeButtonState);
begin
  DrawScrollBarButton(Canvas, R, sbHorizontal, LeftTop, State);
end;

procedure TTeThemeStd.DrawControlFrame(Canvas: TCanvas; R: TRect; State: TTeThemeButtonState);
var
  Color: TColor;
begin
  if State <> ngsDisabled then
...
procedure TTeThemeStd.DrawComboButton(Canvas: TCanvas; R: TRect;
  State: TTeThemeButtonState);
var
  BackColor: TColor;
  GlyphR: TRect;
...
procedure TTeThemeStd.DrawSpeedButton(Canvas: TCanvas; R: TRect;
    ...
    case State of
      ngsNormal:
        ...
        begin
          DrawEdge(Canvas, R, RaisedColor(Color, OuterValue), SunkenColor(Color, OuterValue));
          InflateRect(R, -1, -1);
          DrawEdge(Canvas, R, Color, SunkenColor(Color, InnerValue));
          InflateRect(R, -1, -1);
          FillRect(Canvas, R, Color);
        end
        else
...
procedure TTeThemeStd.DrawSpeedButtonChevron(Canvas: TCanvas; R: TRect;
  State: TTeThemeButtonState; Flat, Exclusive: boolean);
var
  GlyphR: TRect;
begin
...
procedure TTeThemeStd.DrawSpinButton(Canvas: TCanvas; R: TRect;
...
procedure TTeThemeStd.DrawControlBar(Canvas: TCanvas; R: TRect);
begin
  { ControlBar Background }
  FillRect(Canvas, R, GetColor(ngcBtnFace));
end;

procedure TTeThemeStd.DrawControlBarFrame(Canvas: TCanvas; R,
  GrabberRect: TRect);
var
  Color: TKColor;
begin
...
procedure TTeThemeStd.DrawToolbar(Canvas: TCanvas; R: TRect);
begin
  { Draw toolbar }
  FillRect(Canvas, R, GetColor(ngcMenuBar));
end;

procedure TTeThemeStd.DrawGridCell(Canvas: TCanvas; R: TRect;
...
procedure TTeThemeStd.DrawSplitter(Canvas: TCanvas; ARect: TRect; AHot, ABeveled: boolean);
begin
  if ABeveled then
  begin
...
procedure TTeThemeStd.DrawHeaderSection(Canvas: TCanvas; ARect: TRect;
...
procedure TTeThemeStd.DrawStatusBar(Canvas: TCanvas; ARect: TRect);
begin
  FillRect(Canvas, ARect, GetColor(ngcBtnFace));
end;

procedure TTeThemeStd.DrawStatusGripper(Canvas: TCanvas; ARect: TRect);
begin
  DrawFrameControl(Canvas.Handle, ARect, DFC_SCROLL, DFCS_SCROLLSIZEGRIP);
end;

procedure TTeThemeStd.DrawStatusPanel(Canvas: TCanvas; ARect: TRect;
...
procedure TTeThemeStd.DrawScrollBox(Canvas: TCanvas; R: TRect;
  Enabled: boolean);
var
  Color, BColor: TColor;
begin
...
function TTeThemeStd.GetRegion(Width, Height: integer;
